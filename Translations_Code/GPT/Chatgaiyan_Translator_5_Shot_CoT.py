...
def generate_chatgaiyan(csv_path, num_lines=None):
    ...
    with open(csv_path, newline='', encoding='utf-8') as csvfile:
        ...
        for row in reader:
            ...
            append_csv_line('Translation_Output\\GPT\\Translated_Chatgaiyan_5_Shot_CoT\\' + path, translate_bangla_to_chatgaiyan(row))
...
if __name__ == "__main__":
    generate_chatgaiyan(r'BangaCHQ\train.csv')
