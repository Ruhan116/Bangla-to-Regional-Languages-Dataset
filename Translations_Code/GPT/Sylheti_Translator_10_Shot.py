...
Sylheti translation:"""
    try:
        ...
        sylheti_text = response.choices[0].message.content.strip()
...
def generate_sylheti(csv_path, num_lines=None):
    ...
    with open(csv_path, newline='', encoding='utf-8') as csvfile:
        ...
        for row in reader:
            ...
            append_csv_line('Translation_Output\\GPT\\Translated_Sylhet_10_Shot\\' + path, translate_bangla_to_sylheti(row))
